...
public class DisjointSets {
  ...
  public void union(int root1, int root2) {
    //root1 = find(root1);
    //root2 = find(root2);
    if (root1 == root2) {   //checking and handling if trying to join to same set & using find method to check if it is the actual root
      System.out.println("Trying to join a set with itself!");
      return;
    }
